...
function my_portfolio_css_and_js(){
    ...
    wp_register_style('swiper-bundle-min-css', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css', array(), '1.12.1', 'all');
    ...
    wp_enqueue_style('myportfolio-stylesheet', get_stylesheet_uri('style.css'));
